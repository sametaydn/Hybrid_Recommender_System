...
movie = pd.read_csv(r'C:\Users\Sade\Desktop\python\Modül_4_Tavsiye_Sistemleri\Hybrid Recommender System\datasets\movie.csv')
movie.head()
movie.shape

# UserID, film adı, filme verilen oy ve zaman bilgisini içeren veri seti
rating = pd.read_csv('Modül_4_Tavsiye_Sistemleri/Hybrid Recommender System/datasets/rating.csv')
rating.head()
rating.shape
